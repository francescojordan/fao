...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array('geography' => array('class' => 'Jsor\\Doctrine\\PostGIS\\Types\\GeographyType', 'commented' => true), 'geometry' => array('class' => 'Jsor\\Doctrine\\PostGIS\\Types\\GeometryType', 'commented' => true), 'raster' => array('class' => 'Jsor\\Doctrine\\PostGIS\\Types\\RasterType', 'commented' => true)));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \Jsor\Doctrine\PostGIS\Event\ORMSchemaEventSubscriber());

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'francesco', 'user' => 'francesco', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3b2871278f21109dceed6a99e8eb68523df9a766467227e41611a38b59672032');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c1aaa5158729e338f44209029aaab3268e50653e');
    }
    ...
    {
        return $this->services['security.user.provider.concrete.database_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:Users', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 5432,
            'database_name' => 'francesco',
            'database_user' => 'francesco',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'c1aaa5158729e338f44209029aaab3268e50653e',
            'locale' => 'en',
            ...
            'kernel.secret' => 'c1aaa5158729e338f44209029aaab3268e50653e',
